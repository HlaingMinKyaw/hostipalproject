$(document).ready(function(){
    ...
    $(window).scroll(function(){
    	...
    	// // console.log(getscrollheight); // 4616
    	// var getclientheight = $(window).height();
    	// // console.log(getclientheight); //633
    ...
    $("#videos").click(function(){
    	...
    	// console.log(getmodal); //#videomodal
    	// console.log(getvideosrc); //https://www.youtube.com/embed/2kyPgu03pgE
